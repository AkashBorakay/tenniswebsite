...
from resources.StringerMasterResource_V2 import StringerRegister, StringerPasswordUpdate, StringerList, GetDataForForgotPasswordStringer
from resources.WebsiteShopTestingRacketResource import RacketDetail, GetRacketDetailAsPerUniqueValues, AssingNewQRCode, RacketDataBySuperAdmin, GetRacketDataBySuperAdmin, CheckQRCodeMessage, RacketStatus
from resources.WebsiteQRCodeMasterResource import CheckQRCodeDecrypted
from resources.WebsiteCustomerResource import CustomerRegisterFromAdmin, CustomerDetail, CustomerPasswordUpdate, GetDataForForgotPassword, CustomerInfo, CustomerListV2, CheckCustomer
from resources.RacketFilterAndSearchViewResource import RacketFilterAccordingToSelection
from resources.WebsiteRacketBookingDetailResource import CancelOrder, CheckCountCustomerBookedRacket, Dashboard, RacketOrderHistory, BookedCalendarDates_V2, CustomerHistoricOrder, CustomerOrder, ReturnRacketViaQrCode, AutoCancleCustomerOrder, OrderStatusInArray, QuestionBeenAsk, ReminderSendViaSendgrid, ReminderSendgridReturn
...
from resources.FilterAndSearchRacketResource import RacketTestingFilter, RacketMasterFilter
from resources.RacketMarkRessource import Racket_Marks, Racket_Marks_Info
...
api.add_resource(QrScanner,'/api/V1/QrScanner')



#Password Customer
api.add_resource(CustomerPasswordUpdate,'/api/V1/CustomerPasswordUpdate')
api.add_resource(UpdatePasswordResource,'/api/V1/UpdatePassword') #link to reset pwd
...
api.add_resource(UpdatePasswordStringerResource,'/api/V1/UpdatePasswordStringer') #link to reset pwd
