        ...
        try:
            if AdminOrClient == 0:
                ...
                if StringerDetail:
                    ...
                    CheckRoleName = WebsiteRoleManagementModel.GetRoleMaster(StringerDetail.RoleID)
                    ShopID = StringerDetail.ShopID
                    StringerID = StringerDetail.id
                    ...
                    return {"message":IsValidate, "StringerID" : StringerDetail.id, "StringerName":StringerDetail.Name, "StringerLastName":StringerDetail.Lname, 
                                "EmailAddress" : StringerDetail.EmailAddress, "ShopID":StringerDetail.ShopID, "RoleID":StringerDetail.RoleID, "IsCustomer":False}
                else:
