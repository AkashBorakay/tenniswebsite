    ...
    def post(self):
        try:
            ...
            if CheckEmailExistOrNotForStringer:
                ...
                ResetPasswordLink = os.environ.get('AzureAppServiceURL_Websiste') + "/api/V1/UpdatePasswordStringer?StringerID=" + str(StringerID) + "&ShopID=" + str(ShopID)
